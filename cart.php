                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-remove"> 
                                                <a href="#" class="text-danger" id="eliminar-card" title="Vaciar Carritof"> <i class="fa fa-trash-o" aria-hidden="true"></i> </a> 
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody id="table-cart"></tbody>
                                </table>
                                <div class="text-center my-3" id="no-product"></div>
                            </div>
                            <!-- Table Content Start -->
                            <div class="row">
                               <!-- Cart Button Start -->
                                <div class="col-md-8 col-sm-12">
                                    <div class="buttons-cart">
                                        <a href="shop_product.php">Seguir Comprando</a>
                                    </div>
                                </div>
                                <!-- Cart Button Start -->
                                <!-- Cart Totals Start -->
